...
const APP_NAV_ITEMS: AppNavItem[] = [
  ...
  { label: 'Assessment', icon: ClipboardList, to: '/assessment' },
            ...
            {showMarketingNav ? (
              <>
                ...
                <nav className="hidden md:flex items-center space-x-8">
                  ...
                  <NavLink to="/assessment" className={({ isActive }) => appNavLinkClass(isActive)}>
                    Assessment
                  </NavLink>
                </nav>
              ...
              <>
                ...
                <nav className="hidden lg:flex items-center space-x-6 overflow-x-auto">
                  {APP_NAV_ITEMS.map((item) => (
                    <NavLink key={item.label} to={item.to} className={({ isActive }) => appNavLinkClass(isActive)}>
                      {item.label}
                    </NavLink>
                  ))}
                </nav>
                      ...
                      {profileMenuOpen && (
                        <div className="absolute right-0 mt-2 w-56 bg-white border border-[#EDECE8] rounded-2xl shadow-lg overflow-hidden z-50 animate-fade-in">
                          <div className="px-4 py-3 border-b border-stone-100">
                            <div className="text-sm font-bold text-slate-900 truncate">{user?.name || 'Account'}</div>
